            ...
            <div class="row justify-content-between align-items-center">
                <div class="col-md-6 position-relative">
                    <div class="pl-lg-350 py-250">
                        <h1 class="h3 text-white text-capitalize font-weight-bold position-relative z-index-100"><?php the_field('hero_text');?></h1>
                ...
                <div class="col-md-4 col-lg-3">
                    <div class="pr-lg-2 pt-1 mt-md-0">
                        <p class="text-white font-weight-bold"><?php the_field('hero_secondary_text');?></p>
                    </div><!-- pr -->
                </div><!-- col -->
                <?php endif; ?>
            </div><!-- row -->
